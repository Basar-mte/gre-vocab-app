    ...
    <div className="flex min-h-dvh flex-col md:flex-row">
      <div className="hero-band flex flex-1 flex-col items-center justify-center px-8 py-16 text-center md:px-14">
        <div className="relative flex max-w-sm flex-col items-center">
          ...
          <p className="mt-3 text-[#c9c5c1]">We&apos;ll email you a link to get back into your account.</p>
        </div>
      </div>

      <div className="flex flex-1 items-center justify-center bg-[#f5f5f5] px-4 py-12">
        <div className="w-full max-w-md">
          <h2 className="text-xl font-bold text-brand-900">Forgot your password?</h2>
          <p className="mt-1 text-sm text-brand-700/70">Enter your account email and we&apos;ll send a reset link.</p>
